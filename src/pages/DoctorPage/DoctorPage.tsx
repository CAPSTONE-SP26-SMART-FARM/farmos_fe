...
const doctorViews: Record<string, DoctorView> = {
  dashboard: {
    ...
    widgets: ["Phiếu mới", "Đang xử lý", "Thời gian phản hồi TB", "Đã giải quyết hôm nay"],
  },
  "assigned-farms": {
    title: "Trang trại phụ trách",
    description: "Danh sách farm/zone được phân công theo dõi.",
    widgets: ["Tổng đã phân công", "Trang trại hoạt động", "Cần theo dõi thêm", "Khu vực rủi ro cao"],
  },
  incidents: {
    title: "Hộp thư sự cố",
    description: "Danh sách báo cáo bệnh/bất thường từ Farmer và Manager.",
    widgets: ["Báo cáo chưa đọc", "Ca khẩn cấp", "Chờ chẩn đoán", "Ca đã leo thang"],
  },
  "treatment-plans": {
    title: "Chẩn đoán và phác đồ điều trị",
    description: "Tạo chẩn đoán, kê phác đồ điều trị và khuyến nghị xử lý.",
    widgets: ["Phác đồ nháp", "Phác đồ đã duyệt", "Tình hình dùng thuốc", "Cập nhật phác đồ"],
  },
  "treatment-tracking": {
    title: "Theo dõi điều trị",
    description: "Theo dõi tiến độ điều trị và phản hồi sau xử lý.",
    widgets: ["Đang điều trị", "Ca hồi phục", "Ca không đáp ứng", "Ca có thể đóng"],
  },
  "ticket-history": {
    title: "Lịch sử phiếu",
  ...
  "knowledge-base": {
    ...
    widgets: ["Tổng bài viết", "Cập nhật gần đây", "Hướng dẫn phổ biến", "Nội dung nháp"],
  },
  notifications: {
    title: "Thông báo",
  ...
  reports: {
    ...
    widgets: ["Tổng kết tuần", "Tổng kết tháng", "Nhóm bệnh phổ biến", "Xu hướng xử lý"],
  },
};
