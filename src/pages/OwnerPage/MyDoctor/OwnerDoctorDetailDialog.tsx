...
const OwnerDoctorDetailDialog = ({ id, setId }: Props) => {
	...
	const detail: AssignmentWithDoctorResType | undefined = detailQuery.data?.data;
		...
		>
			<DialogContent className="sm:max-w-3xl">
				<DialogHeader>
					...
					<DialogDescription>
						Thông tin doctor được phân công cho farm của bạn.
					</DialogDescription>
				</DialogHeader>
				...
				{detailQuery.isLoading ? (
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>Record was not found.</CardDescription>
						</CardHeader>
					</Card>
				) : (
