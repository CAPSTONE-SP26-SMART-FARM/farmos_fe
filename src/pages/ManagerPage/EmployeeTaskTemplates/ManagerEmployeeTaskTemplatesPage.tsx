...
function ManagerEmployeeTaskTemplatesPage() {
  ...
  const { data, isLoading } =
    useManagerListEmployeeTaskTemplates(effectiveQuery);
        ...
        <div className="relative flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-muted-foreground md:text-base">
              Xem danh sách template nhiệm vụ tiêu chuẩn để giao việc cho nhân
              viên nông trại.
            </p>
          </div>
...
export default ManagerEmployeeTaskTemplatesPage;
